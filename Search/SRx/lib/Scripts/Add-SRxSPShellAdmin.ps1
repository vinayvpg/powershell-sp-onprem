Write-Host "Specify domain\username you wish to grant shell access to." -BackgroundColor DarkCyan -ForegroundColor White
Write-Host "(e.g. 'NORTHAMERICA\CBROWN')." -BackgroundColor DarkCyan -ForegroundColor White
while(-not ($username -imatch '^\w+[\\]\w+$'))
{
	$username= Read-Host ">> Enter the name"
}
...
$title = "" 
$message = "You have entered '$username'. Is this correct?"
$result = $host.ui.PromptForChoice($title, $message, $options, 0)
switch ($result) 
{
	0 { Write-Host "Yes"; $choiceConfirmed = $true}
	1 { Write-Host "No"; $username = "" }
}
if($choiceConfirmed)
{
    Write-Host "Granting access to search admin database" -BackgroundColor DarkCyan -ForegroundColor White
    Add-SPShellAdmin -UserName $username -database $xssa.SearchAdminDatabase.Id
    Write-Host "Granting access to crawl store databases" -BackgroundColor DarkCyan -ForegroundColor White
    $xssa.CrawlStores | % {Add-SPShellAdmin -UserName $username -database $_.Id}
    Write-Host "Granting access to analytics databases" -BackgroundColor DarkCyan -ForegroundColor White
    $xssa.AnalyticsReportingDatabases | % {Add-SPShellAdmin -UserName $username -database $_.Id}
    Write-Host "Granting access to link store databases" -BackgroundColor DarkCyan -ForegroundColor White
    $xssa.LinksStores | % {Add-SPShellAdmin -UserName $username -database $_.Id}
    Write-Host "Granting access to usage database" -BackgroundColor DarkCyan -ForegroundColor White
    Get-SPUsageApplication | % {Add-SPShellAdmin -UserName $username -database $_.UsageDatabase.ID}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB/m2bk0AjokdmT
# VtAElaMUIzOTGDa3FH9lusEF6W6nhqCCDZMwggYRMIID+aADAgECAhMzAAAAjoeR
...
# KoZIhvcNAQkEMSIEIAeF1OEx773NAdPnpRDYsuD71pf5M9XBZ+fQRoHfB0q7MIH8
...
# LWRpYWdub3N0aWNzMA0GCSqGSIb3DQEBAQUABIIBAEVZMeKTBPkNTOU8cqzlxKd1
# 7G0X6lv6MP9dkzznmfRGDyMd6anj+v3ZLf+flhKATlUjU/b/9Rl7VdJEmoNPiJq7
# GsWCGCY1X2hG/DKLJST1GBJhVpjPBIZlLu9tEXh9Mc/Dr5GlpkAt/yD5OchKvDAh
# VRPamVnDHrR1xYdO5Xx2S3RaCPt/TL1Z9UIXrDIw/81I8Vgpe2XWbUGN/Z/FoKHp
# 3i0NatJ4MVY2WcyL4RB1keutsbC8x7NL/BfI+Y2c9w0pf/yReAk08T/3SUwlRRl7
# IL3rQCA5l5481qyWgdKvsRoQgdeCbc8j5jlD2/QS5TWjKzP/2PgRmr+I4ZBOoceh
...
# AQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQga6Kmj32ut6ym+cDE/d+v
# 1bplIUy10UDAXWXle3FpDJoCBljVRUm8ZhgTMjAxNzA0MjYyMzUzNDYuNDE5WjAH
...
# 9w0BCQMxDQYLKoZIhvcNAQkQAQQwLwYJKoZIhvcNAQkEMSIEIF/J6b2AzUhGVBWM
# 48xH/cJPw0Ba/kNaIXO2pybn6HykMIHiBgsqhkiG9w0BCRACDDGB0jCBzzCBzDCB
...
# f93iigE5Mjb/ajANBgkqhkiG9w0BAQsFAASCAQAUzLLr9616hVscyxxUa3/jEw+g
# 6OMGYN53jdSjhzfp/0vlV0RQ7rotRMUG4h8SSoq7RS191EO+/SOoi9NouC9vce0Q
# GqdnC6CLKsEt2g3sTlNB0XTpW4rYaOejW5OZczZIMymP25UBzbpbg6vYg2mf+mPa
# lkTVSwlYc1m5de16nnKuAkQLl/WIX2FOtqRWsMEzs8fgmhd/NfFpvyCqRtg0OQkC
# 6xx3HBLoRzf885zWBM9535bbpv9sCG4HhZJm03EOAt58yB/FVAf2wR2ofZSFU+On
# dym/1dsQIy9gM8cUUghZPqbwxcBRSxHgzhb/fCKC8LwMOB3bGpJoforiWlsB
